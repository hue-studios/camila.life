...
module.exports = {
  ...
  head: {
    ...
    meta: [
      ...
      { property: 'og:url', content: 'https://www.camila.life' },
      { property: 'og:image', content: 'https://huestudios.com/sites/camila.life/content/storage/uploads/CAMILA-FB.jpg' },
      { property: 'og:title', content: 'camila.life - Plant-Based Vegan Living - Loving a Healthy Life' },
      { property: 'og:description', content: 'camila.life is focused on plant-based living to discover your own potential to live a happy, healthy life full of wellth!!' },
      { property: 'og:site_name', content: 'camila.life' },
      { property: 'og:type', content: 'website' },
      { property: 'fb:app_id', content: '112054666106286' }
    ],
    script: [
