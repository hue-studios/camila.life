...
<vk-grid class="uk-grid uk-flex uk-flex-center uk-flex-middle uk-text-center">
  <h1 class="uk-width-5-6 body-font uk-text-lowercase">Welcome back<span class="pink" v-if="this.$auth.user.given_name">  {{this.$auth.user.given_name}} </span>...give us a moment to update your settings.</h1>
</vk-grid>
</template>
