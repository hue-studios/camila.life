...
<div>
  <vk-card class="uk-flex uk-flex-center uk-flex-middle listing-item" hover>
    <div class="uk-position-relative listing-top">
      <listButtons :id="ingredient.id" :category="ingredient.category" :name="ingredient.name" type="ingredient" :brand="ingredient.brand" :url="ingredient.url" :image="this.image" />
