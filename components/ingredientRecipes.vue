...
<div class="ingredient-recipe">
  <nuxt-link :to="'/vegan-plant-based-recipes/' + recipe.url">
    <div class="ingredient-recipe-image" :style="'background-image: url(https://huestudios.com' + image + ')'">
      <h3 class="bold-font text-lowercase">{{makeHeart(recipe.name)}} <i class="fa fa-heart" aria-hidden="true"></i></h3></div>
